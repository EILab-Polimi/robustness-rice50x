...
plt_miu_compr <- plotter_map( data =  TEMPdata$MIU_compromise  %>% 
                                rename(n=Region, 
                                       value='2080') # set as value the desired year
                              ...
                              , label = "b"
                              , extra_legend = " %"
                              , TeX_title = "Mitigation in 2080 - Compromise solution")
plt_miu_compr 
...
plt_delta_welf <- plotter_map( data =  TEMPdata$MIU_compDELTAwelfare  %>% 
                               ...
                               , label = "a"
                               , extra_legend = " %"
                               , TeX_title = "Compromise-Welfare solutions difference in 2080 mitigation")
...
plt_delta_temp <- plotter_map( data =  TEMPdata$MIU_compDELTAtemperature  %>% 
                               ...
                               , label = "c"
                               , extra_legend = " %"
                               , TeX_title = "Compromise-Temperature solutions difference in 2080 mitigation")
plt_delta_temp
...
plt_delta_ineq <- plotter_map( data =  TEMPdata$MIU_compDELTAinequality  %>% 
                               ...
                               , label = "d"
                               , extra_legend = " %"
                               , TeX_title = "Compromise-Inequality solutions difference in 2080 mitigation")
plt_delta_ineq
